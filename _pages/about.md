...
**We are seeking a postdoctoral research fellow!!** The Open Source Software Usability (OSS-U) project jointly hosted at McGill University and Polytechnique Montreal is seeking a postdoctoral research fellow. Please see the [details]({{ '/assets/pdf/PostDoc_OSSU.pdf' | prepend: site.baseurl | prepend: site.url }}) and contact us if you are interested!
